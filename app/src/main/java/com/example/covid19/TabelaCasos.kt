...
class TabelaCasos(db: SQLiteDatabase) {
    ...
    companion object{
        ...
        const val CAMPO_DATA_VACINA = "data"
        const val CAMPO_ID_CIDADES = "id_cidades"

        val TODAS_COLUNAS = arrayOf(BaseColumns._ID, CAMPO_INFETADOS, CAMPO_ATIVOS, CAMPO_OBITOS, CAMPO_DATA_VACINA, CAMPO_ID_CIDADES)
    }
}