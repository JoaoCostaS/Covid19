 ...
 * Use the [Fragment_lista_foco_contagio.newInstance] factory method to
...
class Fragment_lista_foco_contagio : Fragment(),  LoaderManager.LoaderCallbacks<Cursor> {
    ...
    fun navegaEliminarFocoContagio(){
        findNavController().navigate(R.id.action_fragment_lista_foco_contagio_to_eliminaFocoContagioFragment)
    }
    ...
    override fun onLoadFinished(loader: Loader<Cursor>, data: Cursor?) {
        adapterFocoContagio!!.cursor = data
    }
    ...
    override fun onLoaderReset(loader: Loader<Cursor>) {
        adapterFocoContagio!!.cursor = null
    }
